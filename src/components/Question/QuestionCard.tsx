    ...
    <div className="max-w-4xl mx-auto">
      ...
      {answered && (
        <div className={`rounded-xl border-2 p-6 mb-6 ${
          ...
          {question.choices.filter(c => c.label !== question.correctAnswer && question.explanation.whyWrongByChoice?.[c.label]).length > 0 && (
          <div>
            <h4 className="font-semibold text-slate-200 mb-2">Why the other choices are wrong:</h4>
            <div className="space-y-2">
              {question.choices
                .filter(c => c.label !== question.correctAnswer && question.explanation.whyWrongByChoice?.[c.label])
                .map(c => (
